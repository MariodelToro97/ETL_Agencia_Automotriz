<table class="table table-striped" id="tablaHerramientas">
    ...
    <tbody>
        <?php
            ...
            $sql = "SELECT * FROM Herramientas ORDER BY id ASC";
          ...
          <?php
              if (preg_match($numeros, $mostrar['id'])) {
                ...
                <?php }
                 ...
                 if (preg_match($letras_otro, $mostrar['nombreHerramienta'])) {
                   ?>
                     <td><?php echo $mostrar['nombreHerramienta']; ?></td>
                     <td hidden>2</td>
                   <?php
                 }else {

                   ?>
                   <td class="bg-danger"> <?php echo $mostrar['nombreHerramienta']; ?> </td>
                   <td hidden>1</td>
                ...
                ?>
            <td>
                <button class="btn btn-info btn-sm" value="<?php echo $mostrar['id']; ?>" name="<?php echo $contador ?>" type="button" onclick="cargarDatosHerramientas(this)" data-toggle="modal" data-target="#modalHerramienta">Editar Campo</button>
                <button class="btn btn-danger btn-sm" value="<?php echo $mostrar['id']; ?>" type="button" name="" onclick="eliminarDatosHerramientas(this)">Eliminar Persona</button>
            </td>
            <?php
          } ?>
        </tr>
