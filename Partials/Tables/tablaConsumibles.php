<table class="table table-striped" id="tablaConsumibles">
    <thead>
        <tr>
            <th scope="col">idConsumible</th>
    ...
    <tbody>
        <?php
            ...
            $sql = "SELECT * FROM Consumibles ORDER BY id ASC";
          ...
          <?php
              if (preg_match($numeros, $mostrar['id'])) {
                ...
                <?php }
                 ...
                 if (preg_match($letras_otro, $mostrar['producto'])) {
                   ?>
                   ...
                   ?>
                   <td class="bg-danger"> <?php echo $mostrar['producto']; ?> </td>
                   <td hidden>1</td>
                ...
                ?>
            <td>
                <button class="btn btn-info btn-sm" value="<?php echo $mostrar['id']; ?>" name="<?php echo $contador ?>" type="button" onclick="cargarDatosConsumibles(this)" data-toggle="modal" data-target="#modalConsumibles">Editar Campo</button>
                <button class="btn btn-danger btn-sm" value="<?php echo $mostrar['id']; ?>" type="button" name="" onclick="eliminarDatosConsumibles(this)">Eliminar Persona</button>
            </td>
            <?php
          } ?>
        </tr>
