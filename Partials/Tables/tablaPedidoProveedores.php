<table class="table table-striped" id="tablaPedidoProveedores">
    <thead>
        <tr>
            ...
            <th scope="col">tiempoEstimado</th>
    ...
    <tbody>
        <?php
          ...
          $pedido = "/^[1-9][0-9]+$/";
            ...
            $sql = "SELECT * FROM PedidoProveedores ORDER BY id_pedido ASC";
        ...
        <tr>
          <?php
              if (preg_match($numeros, $mostrar['id_pedido'])) {
                       ...
                       if (preg_match($fecha1, $mostrar['fecha'])) {
                         ...
                         <?php }
                           ...
                           if (preg_match($numeros, $mostrar['cantidad'])) {
                             ...
                             if (preg_match($letras_otro, $mostrar['tiempo_estimado'])) {
                               ?>
                               ...
                               ?>
                               <td class="bg-danger"> <?php echo $mostrar['tiempo_estimado']; ?> </td>
                               <td hidden>1</td>
                ...
                ?>
            <td>
                <button class="btn btn-info btn-sm" value="<?php echo $mostrar['id_pedido']; ?>" name="<?php echo $contador ?>" type="button" onclick="cargarDatosPedidoProveedores(this)" data-toggle="modal" data-target="#modalPedidoProveedor">Editar Campo</button>
                <button class="btn btn-danger btn-sm" value="<?php echo $mostrar['id_pedido']; ?>" type="button" name="" onclick="eliminarDatosPedidoProveedores(this)">Eliminar Persona</button>
            </td>
            <?php
          } ?>
        </tr>
