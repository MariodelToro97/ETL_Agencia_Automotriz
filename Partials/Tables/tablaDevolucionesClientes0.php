<table class="table table-striped " id="tablaDevoluciones0">
    <thead>
        <tr>
    ...
    <tbody>
        <?php
            ...
            $sql = "SELECT * FROM devoluciones_clientes ORDER BY idDevolucion ASC";
          ...
          <?php
              if (preg_match($numeros, $mostrar['idDevolucion'])) {
                ...
                <?php }
                 ...
                 if (preg_match($numeros, $mostrar['idProducto'])) {
                   ?>
                   ...
                   ?>
                   <td class="bg-danger"> <?php echo $mostrar['idProducto']; ?> </td>
                   <td hidden>1</td>
                  ...
                  ?>
            <td>
                <button class="btn btn-info btn-sm" value="<?php echo $mostrar['idDevolucion']; ?>" name="<?php echo $contador ?>" type="button" onclick="cargarDatosDevolucionesClientes0(this)" data-toggle="modal" data-target="#modalDevolucionClientes0">Editar Campo</button>
