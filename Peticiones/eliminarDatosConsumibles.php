...
if (!empty($id)) {
    ...
    if(sqlsrv_query($conn_sis, $sql)){
      ...
      $sql = "INSERT INTO bitacora1 (id, usuario, fechaentrada, fechaSalida, Accion, nombreTabla, fechaModificacion, idCampo) VALUES ('','$usuario','', '', 'ELIMINAR', 'CONSUMIBLES', CURRENT_TIMESTAMP, $id)";
